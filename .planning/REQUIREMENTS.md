...
- [ ] **INFRA-03**: Automated test suite (Vitest) covering core library deterministic operations
- [ ] **INFRA-04**: GitHub Actions CI running tests on Windows and macOS runners
